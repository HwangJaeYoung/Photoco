...
public class MyPhotoFragment extends Fragment implements ViewForMyPhotoFragment.Controller {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        list.add(new MockUp("http://farm7.staticflickr.com/6101/6853156632_6374976d38_c.jpg"));
        list.add(new MockUp("http://farm7.staticflickr.com/6101/6853156632_6374976d38_c.jpg"));
        list.add(new MockUp("http://farm8.staticflickr.com/7232/6913504132_a0fce67a0e_c.jpg"));
        list.add(new MockUp("http://farm9.staticflickr.com/8483/8218023445_02037c8fda.jpg"));
        list.add(new MockUp("http://farm9.staticflickr.com/8335/8144074340_38a4c622ab.jpg"));
        list.add(new MockUp("http://farm9.staticflickr.com/8208/8219397252_a04e2184b2.jpg"));
        list.add(new MockUp("http://farm9.staticflickr.com/8483/8218023445_02037c8fda.jpg"));
        list.add(new MockUp("http://farm9.staticflickr.com/8335/8144074340_38a4c622ab.jpg"));
        list.add(new MockUp("http://farm9.staticflickr.com/8185/8081514424_270630b7a5.jpg"));
